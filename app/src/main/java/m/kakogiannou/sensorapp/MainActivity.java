...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button devicesNearMeBtn = findViewById(R.id.devicesNearmeBtn);
        ...
        //set listener for button
            devicesNearMeBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {

                    //add intent that takes use to the sensor's activity if the button pressed
                    Intent devicesIntent = new Intent(MainActivity.this, nearMeActivity.class);
